...
방문자는 소개, 기술 스택, 프로젝트, 학습 기록을 한 흐름 안에서 살펴볼 수 있고, GitHub README나 배포 링크를 통해 관련 결과물을 바로 확인할 수 있습니다.

콘텐츠는 PostgreSQL에 저장하고, 관리자 경로에서만 수정할 수 있도록 구성해 공개 화면과 관리 기능을 분리했습니다. 또한 섹션 순서, 앵커 내비게이션, 카드형 정보 구조를 정리해 한 화면에서 빠르게 탐색할 수 있도록 구성했습니다.
...
**링크 미리보기 (Open Graph)**  
<img src="./public/portfolio/og.png" alt="Lui Archive 링크 미리보기 카드" width="280" />
...
방명록 (방문자·관리자) — 읽는 순서: 작성 → 관리 수신 설정 → 방문 수신 OFF → 관리 삭제
...
<table>
  <tr>
    <td align="center" valign="top" width="50%">
      ...
      <img src="./public/portfolio/guestbook_guest.gif" alt="방명록 방문자 작성" width="200" />
    </td>
    <td align="center" valign="top" width="50%">
      <strong>관리 · 수신 설정</strong><br />
      <img src="./public/portfolio/admin_subreject.gif" alt="관리자 방명록 수신 설정" width="200" />
    </td>
  </tr>
  <tr>
    <td align="center" valign="top">
      <strong>방문 · 수신 OFF</strong><br />
      <img src="./public/portfolio/guest_subreject.gif" alt="방명록 수신 거부 시" width="200" />
    </td>
    <td align="center" valign="top">
      <strong>관리 · 삭제</strong><br />
      <img src="./public/portfolio/admin_delete.gif" alt="관리자 방명록 삭제" width="200" />
    </td>
  </tr>
</table>
